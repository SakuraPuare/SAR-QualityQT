...
AnalysisResult performClarityAnalysis(const cv::Mat &inputImage) {
  ...
  result.analysisName =
      QCoreApplication::translate("Analysis", "Clarity (Gradient Magnitude)");
  result.detailedLog = QCoreApplication::translate(
      "Analysis", "Clarity Analysis (Average Gradient Magnitude):\n");
  QString overviewPrefix =
      QCoreApplication::translate("Analysis", "Clarity (GradMag): ");
  ...
  result.detailedLog += QCoreApplication::translate(
      "Analysis", "Preparing 8-bit grayscale image...\n");
  ...
  if (analysisMat.empty() || analysisMat.type() != CV_8UC1) {
    result.detailedLog += QCoreApplication::translate(
        "Analysis", "\nError: Failed to prepare 8-bit single channel image for "
  ...
  try {
    result.detailedLog += QCoreApplication::translate(
        "Analysis", "Calculating gradients using Sobel operator...\n");
    ...
    result.detailedLog += QCoreApplication::translate(
        "Analysis", "Calculating average gradient magnitude...\n");
    ...
    result.detailedLog += QCoreApplication::translate(
                              "Analysis", "Average Gradient Magnitude: %1\n")
                              .arg(averageGradient);
    result.detailedLog += QCoreApplication::translate(
        "Analysis", "\nInterpretation: Higher values generally indicate "
    ...
    result.detailedLog +=
        QCoreApplication::translate("Analysis",
                                    "Internal Log: OpenCV Error during Clarity "
